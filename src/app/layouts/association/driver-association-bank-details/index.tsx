...
const AssociationBankDetails = () => {
    ...
    const fetchBankDetails = useCallback(async () => {
        if (!userId) {
            showToast(t('userNotFound', 'User not found. Please log in again.'));
            setLoading(false);
            return;
        }
        try {
    ...
    const handleSave = async () => {
        ...
        for (const [key, label] of Object.entries(requiredFields)) {
            if (!bankData[key as keyof typeof bankData]) {
                showToast(t('pleaseFillFields', { field: label }));
                return;
            }
        }
        ...
        try {
            ...
            if (response?.data?.success) {
                ...
                showToast(response?.data?.message || t('failedToUpdateDetails'));
            }
        } catch (err: any) {
                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    ...
                    >
                        <View style={styles.flatContainer}>
                            ...
                            <View style={styles.divider} />
                            {renderInput(t('ifscCode'), bankData.ifsc_code, 'ifsc_code', 'default', 'characters')}
                            <View style={styles.divider} />
...
export default AssociationBankDetails;