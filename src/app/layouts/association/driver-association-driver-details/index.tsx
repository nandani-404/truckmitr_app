...
const DriverAssociationDriverDetails = () => {
    ...
    const fetchDetails = useCallback(async () => {
        ...
        try {
            setLoading(true);
            setError(null);
            const response = await axiosInstance.get(END_POINTS.GET_ASSOCIATION_DRIVER_DETAILS(driverParam.id));
...
export default DriverAssociationDriverDetails;
