    ...
    const ToggleButton = () => (
        <View style={styles.toggleContainer}>
            ...
            >
                ...
                <Text style={[styles.toggleText, viewMode === 'map' && styles.toggleTextActive]}>{t('puncture_nearby_map')}</Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
                ...
                <Text style={[styles.toggleText, viewMode === 'list' && styles.toggleTextActive]}>{t('puncture_nearby_list')}</Text>
            </TouchableOpacity>
        </View>
    );
            ...
            <SafeAreaView style={{ backgroundColor: '#fff' }}>
                <View style={[styles.header, shadow, { paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0 }]}>
                    ...
                    <View style={styles.headerTitleContainer}>
                        <Text style={styles.headerTitle}>{t('puncture_nearby_title')}</Text>
                        <Text style={styles.headerSubtitle}>{t('puncture_nearby_subtitle')}</Text>
                    </View>
            ...
            <View style={styles.content}>
                ...
                {viewMode === 'map' ? (
                    <View style={styles.mapContainer}>
                        ...
                        >
                            {/* Shop Location (Center) */}
                            <Marker coordinate={SHOP_LOCATION}>
                            ...
                            <View style={[styles.bottomSheet, shadow]}>
                                ...
                                <View style={styles.sheetActions}>
                                    <TouchableOpacity style={[styles.sheetBtn, { backgroundColor: '#F0F9FF' }]}>
                                        ...
                                        <Text style={[styles.sheetBtnText, { color: colors.royalBlue }]}>{t('puncture_nearby_message')}</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={[styles.sheetBtn, { backgroundColor: colors.royalBlue }]}>
                                        <Ionicons name="call" size={20} color="#fff" />
                                        <Text style={[styles.sheetBtnText, { color: '#fff' }]}>{t('puncture_nearby_call_driver')}</Text>
                                    </TouchableOpacity>
                                </View>
                    ...
                    <View style={styles.listContainer}>
                        <View style={styles.listHeader}>
                            <ToggleButton />
                            <Text style={styles.listCount}>{NEARBY_DRIVERS.length} {t('puncture_nearby_drivers_found')}</Text>
                        </View>
                        <FlatList
                            data={NEARBY_DRIVERS}
