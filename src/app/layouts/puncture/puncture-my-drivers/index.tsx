        ...
        <View style={styles.card}>
            ...
            <View style={styles.cardHeader}>
                ...
                <View style={styles.cardInfo}>
                    ...
                    <View style={styles.tmIdContainer}>
                        <Ionicons name="id-card-outline" size={12} color="#10B981" />
            ...
            <View style={styles.detailsContainer}>
                <View style={styles.detailItem}>
                    ...
                    <View>
                        <Text style={styles.detailLabel}>{t('puncture_driver_mobile')}</Text>
                ...
                <View style={styles.detailItem}>
                    ...
                    <View>
                        <Text style={styles.detailLabel}>{t('puncture_driver_added_on')}</Text>
...
export default function PunctureMyDrivers() {
    ...
    const fetchDrivers = useCallback(async (isRefreshing = false) => {
        ...
        try {
            ...
            const response = await axiosInstance.get(END_POINTS.PUNCTURE_DRIVERS);
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        <View style={styles.emptyState}>
                            ...
                            <Text style={styles.emptyTitle}>{t('puncture_no_drivers_title')}</Text>
                            <Text style={styles.emptyText}>{t('puncture_no_drivers_desc')}</Text>
                        </View>
                    }
                />
            )}
