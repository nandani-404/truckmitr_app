...
export default function PunctureAddDriver() {
    ...
    const referralCode = user?.Referral_Code || 'TM2024PUNCTURE001';
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // formData.append('role', 'puncture'); // Assuming role is handled by backend or implied

            const response = await axiosInstance.post(END_POINTS.PUNCTURE_ADD_DRIVER, formData);
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            ...
            if (response?.data?.status || response?.data?.success) {
                ...
                const errorMessage = response?.data?.message || t('invalidOtp') || t('puncture_add_driver_invalid_otp');
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.formGroup}>
                    <Text style={styles.inputLabel}>{t('puncture_add_driver_full_name') || 'Full Name'}</Text>
                    <TextInput
                        style={[styles.minimalInput, errors.name && styles.inputError]}
                        placeholder={t('puncture_add_driver_name_placeholder') || "Driver's Name"}
                ...
                <View style={styles.formGroup}>
                    <Text style={styles.inputLabel}>{t('puncture_add_driver_mobile') || 'Mobile Number'}</Text>
                    <View style={[styles.minimalInput, styles.phoneInputContainer, errors.mobile && styles.inputError]}>
                        <Text style={styles.phonePrefix}>+91</Text>
                        <TextInput
                            style={styles.phoneInput}
                            placeholder={t('puncture_add_driver_mobile_placeholder') || 'Enter 10-digit number'}
                            placeholderTextColor="#9CA3AF"
                ...
                <View style={styles.formGroup}>
                    <Text style={styles.inputLabel}>{t('puncture_add_driver_email') || 'Email'} <Text style={{ fontWeight: '400', color: '#9CA3AF' }}>({t('puncture_add_driver_optional') || 'Optional'})</Text></Text>
                    <TextInput
                        style={styles.minimalInput}
                        placeholder={t('puncture_add_driver_email_placeholder') || "driver@example.com"}
                        placeholderTextColor="#9CA3AF"
                ...
                <View style={styles.formGroup}>
                    <Text style={styles.inputLabel}>{t('puncture_add_driver_state') || 'State'}</Text>
                    <TouchableOpacity
                ...
                <View style={styles.otpModalOverlay}>
                    <View style={styles.otpModalContainer}>
                        ...
                        <Text style={styles.otpSubtitle}>
                            {t('puncture_add_driver_otp_sent_to') || 'Sent to +91'}: {pendingDriverData?.mobile}
                        </Text>
            ...
            >
                <View style={styles.stateModalContainer}>
                    <View style={[styles.stateModalHeader, { paddingTop: safeAreaInsets.top + 10 }]}>
                        ...
                        <Text style={styles.stateModalTitle}>{t('puncture_add_driver_select_state') || 'Select State'}</Text>
                        <View style={{ width: 24 }} />
                    </View>
                    ...
                    <View style={styles.searchBarContainer}>
                        ...
                        <TextInput
                            ...
                            placeholder={t('puncture_add_driver_search') || 'Search...'}
                            placeholderTextColor="#9CA3AF"
