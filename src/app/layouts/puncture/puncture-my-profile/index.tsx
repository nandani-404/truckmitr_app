...
export default function PunctureMyProfile() {
    const { t } = useTranslation();
    const dispatch = useDispatch()
    useStatusBarStyle('dark-content')
    const { user, isTransporter, profileCompletion, subscriptionDetails, rank, star_rating, subscriptionModal } = useSelector((state: any) => { return state?.user }) || {};
    const isDriver = true;
    const colors = useColor();
...
🔑 मेरा Referral Code: *${referralCode}*
                ...
                <CardContainer>
                    ...
                    {isDriver && (
                        <>
                            ...
                            <MenuItem
                                icon={<MaterialCommunityIcons name="bank" size={20} color="#059669" />}
                                title={t('bankDetails')}
