...
const PunctureDriverSearch = () => {
    ...
    const searchDrivers = async (query: string) => {
        ...
        setHasSearched(true);
        try {
            const response = await axiosInstance.get(END_POINTS.PUNCTURE_DRIVER_SEARCH, {
                params: {
                    search: query
                }
            });
        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            {loading ? (
                ...
                <FlatList
                    ...
                    keyExtractor={(item) => item.driver_id?.toString() || item.id?.toString() || Math.random().toString()}
...
export default PunctureDriverSearch;
