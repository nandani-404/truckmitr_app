...
// Truck Images (same as reference)
const TruckImages = {
    ...
    const renderItem = ({ item }: { item: any }) => {
        return (
            <TouchableOpacity
                ...
                onPress={() => {
                    // Navigate to Add Driver screen or Driver Details? 
                    // User said "use the api too", implying integration with Add Driver probably.
                    // But Association Search goes to Driver Details. 
                    // For Dhaba, let's navigate to Add Driver with prefilled data or just display info for now.
                    // Or maybe we need a dedicated Dhaba Driver Details screen.
                    // For now, let's use the Add Driver screen and pass the TMID/Mobile if applicable,
                    // OR if the user wants "same as association", they might expect a details screen.
                    // Given the request "same as association", I will stick to the search UI. 
                    // Clicking might not have a direct destination in Dhaba yet unless we repurpose Add Driver.
                    // Let's just log for now or navigate to Add Driver if possible.
                    console.log('Selected driver:', item);
                }}
            >
                ...
                <FlatList
                    ...
                    ListEmptyComponent={
                        hasSearched && searchQuery.length > 0 ? (
                            <View style={styles.centerContainer}>
                                {/* Use a default empty image if the specific asset is not available */}
...
export default DhabhaDriverSearch;
