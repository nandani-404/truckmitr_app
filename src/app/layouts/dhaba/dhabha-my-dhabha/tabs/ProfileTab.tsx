...
const ProfileTab = () => {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            console.log('DEBUG: Dhaba Profile update formData:', formData);
            ...
            if (response.data && (response.data.status || response.data.success)) {
                console.log('DEBUG: Dhaba Profile update success. Response:', response.data);
                ...
                console.log('DEBUG: Dhaba Profile update failed. Response:', response.data);
                showToast(response.data?.message || t('updateFailed', 'Failed to update profile'));
            }

        } catch (error: any) {
            console.error('Dhaba Profile update error:', error);
